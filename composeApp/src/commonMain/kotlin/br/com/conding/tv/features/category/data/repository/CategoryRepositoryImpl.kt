...
internal class CategoryRepositoryImpl(
    ...
    override fun findAllCategories(
        ...
        return categoryRemoteDataSource.findAllCategories(
            name = name,
            page = page,
            size = size,
            sort = sort
    ...
    override fun finCategoryByName(
        ...
        return categoryRemoteDataSource.finCategoryByName(name = name)
    }

    override fun createNewCategory(
        category: CategoryRequestDTO
    ): Flow<ObserveNetworkStateHandler<Unit>> {
        return categoryRemoteDataSource.createNewCategory(category = category)
    }

    override fun updateCategory(
        category: UpdateCategoryRequestDTO
    ): Flow<ObserveNetworkStateHandler<Unit>> {
        return categoryRemoteDataSource.updateCategory(category = category)
    }

    override fun deleteCategory(
        id: Long
    ): Flow<ObserveNetworkStateHandler<Unit>> {
        return categoryRemoteDataSource.deleteCategory(id = id)
    }
}
